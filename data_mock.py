...
# 各湖泊采样点位配置
# 基于实际监测点位设置，每个湖泊3~5个典型点位
SAMPLING_POINTS: dict = {
    "千岛湖":   ["千岛湖-入湖口", "千岛湖-湖心", "千岛湖-出湖口"],
    "太湖":     ["平台山", "泽山", "十四号灯标", "漫山", "拖山"],
    "长荡湖":   ["长荡湖-入湖口", "长荡湖-湖心", "长荡湖"],
    "巢湖":     ["巢湖-入湖口", "巢湖-湖心", "巢湖-出湖口"],
    "淀山湖":   ["淀山湖-入湖口", "淀山湖中", "淀山湖-出湖口"],
    "玄武湖":   ["玄武湖"],
    "南湖":     ["南湖中心", "南湖-入湖口", "南湖-出湖口"],
    "潜明水库": ["潜明水库", "潜明水库-坝前", "潜明水库-库中"],
}
...
# 千岛湖 → 贫-中营养，太湖 → 富营养，长荡湖 → 中-富营养，
# 巢湖 → 富营养，淀山湖 → 中营养，玄武湖 → 中营养，
# 南湖 → 中-富营养，潜明水库 → 中营养
